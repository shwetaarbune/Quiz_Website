...
using Style = System.Web.UI.WebControls.Style;

namespace Quizwebsite
{
    public partial class Quizwebsite : System.Web.UI.Page
    {
        ...
        {
            submittedanswer = "DBMS";
        }

        protected void RadioButton2_CheckedChanged(object sender, EventArgs e)
        {
            submittedanswer = "ADBMS";
        }

        protected void RadioButton3_CheckedChanged(object sender, EventArgs e)
        {
            submittedanswer = "Database";
        }

        protected void RadioButton4_CheckedChanged(object sender, EventArgs e)
        {
            submittedanswer = "RDBMS";
        }
