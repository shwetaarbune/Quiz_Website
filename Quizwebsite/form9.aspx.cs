...
{
    public partial class form9 : System.Web.UI.Page
    {
        ...
        {
            submittedanswer = "functions having same variables";
        }

        protected void RadioButton2_CheckedChanged(object sender, EventArgs e)
        {
            submittedanswer = " many functions in the program";
        }

        protected void RadioButton3_CheckedChanged(object sender, EventArgs e)
        {
            submittedanswer = "more than one function having same name";
        }

        protected void RadioButton4_CheckedChanged(object sender, EventArgs e)
        {
            submittedanswer="function having global variables";
        }
